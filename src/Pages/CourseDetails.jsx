    ...
    <div className=' mt-[3.5rem]'>
        ...
        <div  className=' md:w-[60%] w-full p-2'>
         ...
         <div className='w-full md:w-[30%] bg-[#161D29] md:absolute md:top-7 md:right-5 '>
          ...
          <button className=' text-richblack-800 bg-yellow-50 w-[80%] mx-[10%]  p-2 rounded-md'  onClick={handleBuyCourse}>Buy Now</button>
          <button className=' text-richblack-25 bg-richblack-600  w-[80%] mx-[10%] p-2 rounded-md mt-4'  >Add to cart </button>
        ...
        <div className=' w-11/12 mx-auto max-w-maxContent  text-richblack-5 p-2'>
            ...
            <div className=' mt-2 p-4 text-sm md:text-lg text-richblack-100'>{courseData?.whatWillYouLearn}</div>
